...
repo (the gate, 128 source invariants, 19 self-tests, two soaks, the mutation suites) proves the code does
...
- [ ] **J1. `%TEMP%` is not filling up.** Run this after a session and expect a small number, not hundreds:
      ...
      > accumulated 354 of them, 128 MB, while this row kept reporting a clean result. Count both, and
